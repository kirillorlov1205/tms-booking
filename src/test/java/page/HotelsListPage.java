...
public class HotelsListPage {
    ...
    private static final String HOTEL_RATING = "//div[contains(text(),'%s')]//ancestor::div[contains(@class,'c2931f4182')]//div[contains(@class,'d86cee9b25')]";

    public boolean isHotelDisplayed(String hotelName) {
        ArrayList<String> hotelsList = new ArrayList<>();
        $$(HOTELS_LIST).forEach(item -> hotelsList.add(item.getText()));
